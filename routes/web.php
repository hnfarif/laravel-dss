...
Route::get('/criteriaweights/{project}', [CriteriaWeightController::class, 'index'])->name('cw.index');

Route::get('alternative/detail/{id}', [AlternativeController::class, 'detail'])->name('alternatives.detail');
